...
public class ChatNewDeserializableTag extends ChatNewCapturingDeserializable
{
    ...
    public ChatNewDeserializableTag(int protocolVersion, @NonNull SpecificTag chatTag)
    {
        this( ChatSerializer.forVersion( protocolVersion ), chatTag );
    }

    public ChatNewDeserializableTag(@NonNull VersionedComponentSerializer serializer, @NonNull SpecificTag chatTag)
    {
        super( chatTag );
